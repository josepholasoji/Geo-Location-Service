...
public:
	...
	TK103_API std::tuple<data_payload_from_device*, struct _command_message> processRequest(char* ch);
	...
	virtual std::tuple<unsigned char*, int> process(char *, int) override;
